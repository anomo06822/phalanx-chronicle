        ...
        public static Color GetSkillAccent(ActiveSkillType skillType)
        {
            switch (skillType)
            {
                ...
                case ActiveSkillType.FeatherFormation:
                    return new Color(0.68f, 0.9f, 0.98f, 1f);
                ...
                case ActiveSkillType.StormbreakCharge:
                    return new Color(0.47f, 0.62f, 0.97f, 1f);
                case ActiveSkillType.DustDevilSweep:
                    return new Color(0.9f, 0.66f, 0.32f, 1f);
